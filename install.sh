...
sudo apt install -y git curl neofetch btop htop nodejs npm cmake raspberrypi-kernel-headers lsb-release dkms rfkill bc fswebcam ffmpeg v4l-utils minicom gpsd gpsd-clients jq bc
